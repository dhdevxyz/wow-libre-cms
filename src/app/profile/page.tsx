        ...
        <div className="w-full max-w-8xl mx-auto px-6 md:px-8">
          ...
          <div className="flex flex-col sm:flex-row max-sm:gap-5 items-center justify-between mb-5">
            ...
            <button className="rounded-full py-3.5 px-5 bg-gray-100 flex items-center group transition-all duration-500 hover:bg-indigo-100 ">
              ...
              <span className="px-2 font-medium text-base leading-7 text-white-700 transition-all duration-500 group-hover:text-indigo-600">
                Software Engineer
              </span>
            </button>
          </div>
