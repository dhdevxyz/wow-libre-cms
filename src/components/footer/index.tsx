  ...
  return (
    <div className="grid gap-4 justify-items-center py-6 bg-midnight sm:flex sm:justify-between sm:items-center ">
      <div className="flex flex-col items-center text-center sm:ml-4">
        <p className="text-white mb-2 text-lg md:text-xl lg:text-3xl xl:text-3xl">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
          <div className="flex flex-col items-center">
            <img
              ...
              alt="FacebookIcon"
              className="w-12 h-12 rounded-full transition duration-300 ease-in-out transform hover:scale-110"
            />
          </div>
          <div className="flex flex-col items-center">
            <img
      ...
      <p className="text-lg md:text-xl lg:text-3xl xl:text-3xl text-white sm:mt-0">
        Derechos reservados Sierra-code@ 2023
      </p>

      <div className="flex flex-col gap-2 text-center sm:mr-20 text-lg md:text-xl lg:text-3xl xl:text-3xl">
